...
data class EmergencyRequestDraft(
    ...
    val requesterLatitude: Double? = null,
    val requesterLongitude: Double? = null,
    val locationPrecisionMeters: Int = 100,
...
interface EmergencyRequestRepository {
    ...
    suspend fun blockContact(requestId: String, donorId: String): String
