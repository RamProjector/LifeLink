...
fun AuthScreen(
    ...
    val canSubmit = emailValid && passwordValid && passwordsMatch && !busy
    ...
    Surface(color = MaterialTheme.colorScheme.background) {
        Column(
            ...
            Text(
                if (createAccount) "Join the community helping people find blood donors."
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        if (createAccount) "Create your account" else "Sign in",
                        style = MaterialTheme.typography.headlineSmall,
                        fontWeight = FontWeight.SemiBold
                    )
                    Text(
                        if (createAccount) "Use an email address you can open. Supabase may send a confirmation link."
                    ...
                    if (!createAccount) {
                        TextButton(onClick = { /* Password reset will be added with the account recovery flow. */ }, modifier = Modifier.align(Alignment.CenterHorizontally)) {
